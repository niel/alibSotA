...
function ShroudOnStart()
	als.ui.onInit(function()
		...
		function paperdoll.refresh()
			local c = string.style(als.player.stat(317).value, { color = "#ef2929"})
			local l = string.style(als.player.stat(318).value, { color = "#ad7fa8"})
			local t = string.style(als.player.stat(319).value, { color = "#729fcf"})
	...
	als.ui.onClientWindow(function(what, window)
		if what == "moved" then
